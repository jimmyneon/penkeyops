...
-- Determines the "NOW" action for the dashboard
-- ============================================
...
RETURNS TABLE (
  action_type TEXT, -- 'task', 'group', 'start_shift'
  task_id UUID,
  group_id TEXT,
  title TEXT,
  instruction TEXT,
...
-- ============================================
-- Get coming up tasks (next 2-4 items)
-- ============================================
...
COMMENT ON FUNCTION resolve_now_action IS 'Core resolver that determines the single best "NOW" action for the dashboard';
COMMENT ON FUNCTION get_coming_up_tasks IS 'Returns 2-4 upcoming tasks to show in the Coming Up strip';
COMMENT ON FUNCTION get_group_tasks IS 'Returns all tasks in a linked group for the group checklist view';
